<?php
	...
	$rows = isset($_POST['rows']) ? intval($_POST['rows']) : 10;
     $ia_unit = isset($_POST['ia_unit']) ? mysql_real_escape_string($_POST['ia_unit']) : '';
    $ib_unit = isset($_POST['ib_unit']) ? mysql_real_escape_string($_POST['ib_unit']) : '';
    
	$offset = ($page-1)*$rows;

	$result = array();
	$where = "d.unit_kompetensi like '%$ib_unit%'";
