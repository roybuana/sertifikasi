...
ON a.id=b.id_sektor
JOIN bidang c
ON c.id_sub_sektor=b.id WHERE ".$where);
	...
	if($result["total"]==0){
	   ...
	   $rs = mysql_query("SELECT b.id_sektor,a.sektor,b.id,b.sektor_sub,c.bidang,c.id as bid_id
FROM sektor a
JOIN sektor_sub b
ON a.id=b.id_sektor
JOIN bidang c
ON c.id_sub_sektor=b.id WHERE ".$where." ORDER BY b.id ASC limit $offset,$rows");
