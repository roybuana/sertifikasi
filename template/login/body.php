...
<div class="container">
	<section id="content">
		<form id="fm" action="login_process.php" method="post">  
			<h1>Login Form</h1>
			<div>
				<input name="username" type="text" placeholder="Email" required="true" id="username" validType="email" class="easyui-validatebox validatebox-text" />
			</div>
			<div>
